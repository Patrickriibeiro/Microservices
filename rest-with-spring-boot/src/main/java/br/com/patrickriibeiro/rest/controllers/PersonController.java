...
public class PersonController {
	...
	public List<Person> findAllPerson() {
		return personServices.findPersonAll();
	}

	@DeleteMapping(value = "/{id}")
	public void deletePersonById(@PathVariable(name = "id") String id) {
		personServices.delete(Long.valueOf(id));
	}

	@GetMapping(value = "/{id}")
	public Person findPersonById(@PathVariable(name = "id") String id) {
		return personServices.findById(Long.valueOf(id));
	}
